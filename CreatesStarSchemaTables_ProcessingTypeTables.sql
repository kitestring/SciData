CREATE TABLE Sample (id TEXT PRIMARY KEY, Instrument CHARACTER(4), DataSetName TEXT,
	...
	Fluorene_TAF_foreignkey TEXT, Fluorene_PF_foreignkey TEXT,
	Naphthalene_TAF_foreignkey TEXT, Naphthalene_PF_foreignkey TEXT);
...
CREATE TABLE Naphthalene_TAF (id TEXT PRIMARY KEY, ProcessingType TEXT, Area INTEGER,
	Height INTEGER, Peak_SN INTEGER, Quant_SN INTEGER,  
	Quant_Masses TEXT, RT_1D REAL, RT_2D REAL, Tailing_Factor REAL, FWHH REAL, 
	Similarity INTEGER, Concentration_pg REAL, AnalyteName TEXT);
	
CREATE TABLE Naphthalene_PF (id TEXT PRIMARY KEY, ProcessingType TEXT, Area INTEGER,
	Height INTEGER, Peak_SN INTEGER, Quant_SN INTEGER,  
	Quant_Masses TEXT, RT_1D REAL, RT_2D REAL, Tailing_Factor REAL, FWHH REAL, 
	Similarity INTEGER, Concentration_pg REAL, AnalyteName TEXT);
	
CREATE TABLE Fluorene_TAF (id TEXT PRIMARY KEY, ProcessingType TEXT, Area INTEGER,
	Height INTEGER, Peak_SN INTEGER, Quant_SN INTEGER,  
	Quant_Masses TEXT, RT_1D REAL, RT_2D REAL, Tailing_Factor REAL, FWHH REAL, 
	Similarity INTEGER, Concentration_pg REAL, AnalyteName TEXT);
	
CREATE TABLE Fluorene_PF (id TEXT PRIMARY KEY, ProcessingType TEXT, Area INTEGER,
	Height INTEGER, Peak_SN INTEGER, Quant_SN INTEGER,  
	Quant_Masses TEXT, RT_1D REAL, RT_2D REAL, Tailing_Factor REAL, FWHH REAL, 
	Similarity INTEGER, Concentration_pg REAL, AnalyteName TEXT);
