...
class Extract():
	...
	def __init__(self, csvDirectory, db_schema, DebuggingMode):
		self.DebuggingMode = DebuggingMode
		self.csvDirectory = csvDirectory
		self.analyteNameDict = {'OFN': 'OFN',
								'Perfluoronaphthalene': 'OFN',
								'Acenaphthene': 'Acenaphthene',
								'Phenanthrene': 'Phenanthrene',
								'Pyrene': 'Pyrene',
								'Chrysene': 'Chrysene',
								'Benzo(b)fluoranthene': 'Benzo_b_fluoranthene',
								'Benzo[b]fluoranthene': 'Benzo_b_fluoranthene',
								'Benzo[ghi]perylene': 'Benzo_ghi_perylene',
								'Benzo(ghi)perylene': 'Benzo_ghi_perylene'
								}
	...
	def convert_GCMethod_To_Chromatography(self, row):
		...
		chromatographyDict = {'Split 20_1 OFN 30 m column 1D': '1D',
								'Split 20_1 OFN 30m column GCxGC': 'GCxGC',
								'PAH 20_1 1D': '1D',
								'Split 20:1 OFN 30 m column 1D': '1D'
								}
		chromatography = row['[ GC Method ]']
		return chromatographyDict.get(chromatography, "Unknown")
